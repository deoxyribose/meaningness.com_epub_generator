...
PROJECT_URL = "https://github.com/deoxyribose/meaningness.com_epub_generator"
...
class InTheCellsOfTheEggplantEbook:
    def __init__(self, html_root, tmp_path):
        self.tmp_path = tmp_path

        self.html_root = html_root
        self.book = BookGenerator('In The Cells Of The Eggplant')
    ...
    def convert_chapter(self, article_path, chapter_fn, title=None):
        ...
        if not title:
            ...
            title = title.replace(" | In The Cells Of The Eggplant", "", 1)
...
def put_ebook_together(html_path):
    ...
    book = InTheCellsOfTheEggplantEbook(html_path, tmp_name)
    book.generate_ebook('metarationality.epub')
